    ...
    <div class="label-layout">
      <div class="color-layout">
        ...
        <div class="color-grid">
          <div
            v-for="i in typeIconSize"
            class="circle-color"
            :key="i"
            :style="`background-color: ${colorList[i - 1]}`"
        ...
        <el-popover placement="right" :width="274" trigger="click" :visible="showIconList">
          <template #reference>
            <div class="icon-selector" @click="showIconList = !showIconList">
              <circle-icon
                :color="colorList[currentColorIndex - 1]"
                class="icon"
                :svg-name="`ic_type_white${currentIconIndex - 1}`"
              />
            </div>
          </template>
          <div class="type-grid">
            <div
              ...
              :key="index"
              class="icon-wrapper"
              :class="{ unselected: currentIconIndex !== index }"
